...
class CourseAllocationController extends Controller
{
    ...
    public function show($id)
    {
        ...
        if ($course_allocation->course()->exists())
            ...
            return redirect()->route('coordinator.course-allocations.courses', $course_allocation);
            // return view('coordinator.course-allocations.courses', compact('course_allocation', 'courses'));
        }
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            return redirect()->route('coordinator.semester-plan.show', $course_allocation->section)->with('success', "Successfully saved");
        } catch (Exception $e) {
            echo $e->getMessage();
    ...
    public function destroy($id)
    {
        ...
        try {
            ...
            return redirect()->route('coordinator.semester-plan.show', $course_allocation->section)->with('success', 'Successfully removed');
        } catch (Exception $e) {
    ...
    public function teachers($course_allocation_id)
    {
        ...
        $teachers = User::whereRelation('roles', 'name', 'teacher')
            ...
            ->where('is_active', 1)
            ->get();
        return view('coordinator.course-allocations.teachers', compact('course_allocation', 'teachers'));
    }
}
