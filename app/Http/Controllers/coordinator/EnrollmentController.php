...
class EnrollmentController extends Controller
{
    ...
    public function fresh($id)
    {
        ...
        return view('coordinator.course-allocations.enrollment.fresh', compact('course_allocation', 'unregistered'));
    }

    public function reappear($id)
    {
        $course_allocation = CourseAllocation::find($id);
        return view('coordinator.course-allocations.enrollment.reappear', compact('course_allocation'));
    }
    ...
    public function  enrollFresh(Request $request)
    {
        ...
        try {
            ...
            DB::commit();
            return redirect()->route('coordinator.course-allocations.show', $course_allocation)->with('success', 'Successfully enrolled!');
        } catch (Exception $ex) {
            DB::rollBack();
