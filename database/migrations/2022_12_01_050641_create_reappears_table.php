...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('reappears', function (Blueprint $table) {
            ...
            $table->boolean('editable')->default(1); //editable before final submission
            ...
            $table->foreign('first_attempt_id')->references('id')->on('first_attempts')->onUpdate('cascade')->onDelete('cascade');
