...
<div class="container w-full mx-auto mt-8">
    ...
    <form action="{{route('reappear_formative.update', $course_allocation)}}" method="POST" class="mt-12" onsubmit="return validateBeforeSubmit(event)">
        @csrf
        @method('PATCH')
        <div class="flex items-center justify-between py-2 space-x-5 ">
            <div class="flex flex-growtab items-center">
                <a href="{{route('fresh_formative.edit', $course_allocation)}}" class="tab" onclick="viewFresh()">Fresh Students</a>
