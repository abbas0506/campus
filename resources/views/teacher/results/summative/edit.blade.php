...
<div class="flex items-center space-x-4 mt-12">
    ...
    <div>/</div>
    <a href="{{route('fa_formatives.edit', $course_allocation)}}" class="">Formative Assessment</a>
</div>
...
<div class="container w-full mx-auto mt-8">
    ...
    <section id='sxnFresh' class="mt-12">
        <form action="{{route('fa_summatives.update', $course_allocation)}}" method="POST" onsubmit="return validateBeforeSubmit(event)">
            @csrf
            @method('PATCH')
                ...
                <tbody>
                    ...
                    <tr class="tr border-b ">
                        ...
                        <td class="py-3 text-center">
                            <input type="text" name='summative[]' class="outline outline-1 outline-gray-300 text-center py-1 w-24 marks" value="{{$first_attempt->summative}}" placeholder="absent" onchange="validate(event,50)" @if($first_attempt->formative()<17) disabled @endif>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
            ...
            <table class="table-auto w-full mt-8">
                ...
                <tbody>
                    ...
                    <tr class="tr border-b ">
                        ...
                        <td hidden><input type="text" name='id[]' value="{{$reappear->first_attempt->id}}"></td>
                        <td class="py-3 text-center">
                            <input type='text' name='assignment[]' class="outline outline-1 outline-gray-300 text-center py-1 w-24 marks" value="{{$reappear->first_attempt->assignment}}" placeholder="absent" onchange="validate(event,10)">
                        </td>
                        <td class="py-3 text-center">
                            <input type="text" name='presentation[]' class="outline outline-1 outline-gray-300 text-center py-1 w-24 marks" value="{{$reappear->first_attempt->presentation}}" placeholder="absent" onchange="validate(event,10)">
                        </td>
                        <td class="py-3 text-center">
                            <input type="text" name='midterm[]' class="outline outline-1 outline-gray-300 text-center py-1 w-24 marks" value="{{$reappear->first_attempt->midterm}}" placeholder="absent" onchange="validate(event,30)">
                        </td>
                    </tr>
                    @endforeach
                </tbody>
