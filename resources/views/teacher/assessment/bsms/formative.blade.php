                ...
                <table class="table-fixed w-full">
                    <thead>
                        <tr class="border-b border-slate-200 text-sm">
                            ...
                            <th class="text-center w-20">Asgn <br> <span class="font-thin">(10%)</span></th>
                            <th class="text-center w-20">Pres<br> <span class="font-thin">(10%)</span></th>
                            <th class="text-center w-20">Mid<br> <span class="font-thin">(30%)</span></th>
