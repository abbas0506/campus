                ...
                <table class="table-fixed w-full">
                    <thead>
                        <tr class="border-b border-slate-200 text-sm">
                            ...
                            <th class="text-center w-20">Formative <br> <span class="font-thin">(50%)</span></th>
                            <th class="text-center w-20">Summative<br> <span class="font-thin">(50%)</span></th>
                            <th class="text-center w-20">Total<br> <span class="font-thin">(100)</span></th>
                        ...
                        <tr class="tr border-b ">
                            ...
                            @if($first_attempt->formative() < 25) <!-- midterm failed -->
                                ...
                                <td class="py-3 text-center">
                                    <input type="text" name='summative[]' class="outline outline-1 outline-gray-300 text-center py-1 w-16 marks" value='' disabled>
                                </td>
                                @else
