                ...
                <table class="table-fixed w-full">
                    <thead>
                        <tr class="border-b border-slate-200 text-sm">
                            ...
                            <th class="text-center w-24">Summative<br> <span class="font-thin">(50%)</span></th>
                            <th class="text-center w-24">Total<br> <span class="font-thin">(100)</span></th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr class="tr border-b ">
                            ...
                            @if($first_attempt->formative() < 25) <!-- midterm failed -->
                                ...
                                <td class="py-3 text-center">
                                    <input type="text" name='summative[]' class="outline outline-1 outline-gray-300 text-center py-1 w-20 marks" value='' disabled>
                                </td>
                                @else
                                <td class="py-3 text-center">{{$first_attempt->formative()}}</td>
                                <td class="py-3 text-center">
                                    <input type="text" name='summative[]' class="outline outline-1 outline-gray-300 text-center py-1 w-20 marks" value="{{$first_attempt->summative}}" placeholder="absent" onchange="validate(event,50)">
                                </td>
                                <td class="py-3 text-center">
                                    {{$first_attempt->total()}}
                                </td>
                    ...
                    <tbody>
                        ...
                        <tr class="tr border-b ">
                            ...
                            @if($reappear->formative() < 25) <!-- midterm failed -->
                                ...
                                <td class="py-3 text-center">
                                    <input type="text" name='summative[]' class="outline outline-1 outline-gray-300 text-center py-1 w-20 marks" value="{{$reappear->summative}}" placeholder="absent" onchange="validate(event,50)">
                                </td>
                                <td class="py-3 text-center">
                                    {{$reappear->total()}}
                                </td>
