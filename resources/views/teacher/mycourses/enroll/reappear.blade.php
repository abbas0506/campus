...
<div class="container w-full mx-auto mt-8">
    ...
    <div class="flex items-center justify-between py-2 space-x-5 mt-12">
        <div class="flex flex-growtab items-center">
            <a href="{{route('enroll.fa', $course_allocation)}}" class="tab">Fresh Students</a>
        ...
        <div class="flex flex-col w-3/4">
            ...
            <div class="ml-8 hidden" id='last_attempt'>
                ...
                <div class="flex justify-end">
                    <button type='button' class="btn-red rounded mt-4" onclick="enrollReappearer()">Enroll</button>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    function enrollReappearer() {
        ...
        if (rollno == '') {
            Swal.fire({
                icon: 'warning',
                title: "Roll no missing",
            });
        } else {
            //show sweet alert and confirm submission
            Swal.fire({
                title: 'Are you sure?',
                text: "Student will be enrolled in this course!",
                type: 'warning',
