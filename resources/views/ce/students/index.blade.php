...
<div class="container">
    ...
    <div class="bread-crumb">
        <a href="{{url('controller')}}">Cancel & Go Back</a>
    </div>

    <div class="flex flex-col items-center justify-center border border-dashed border-slate-300 bg-slate-50 p-2 mt-2">
        <div><i class="bi bi-person-circle text-slate-600 text-4xl"></i></div>
        <div class="font-semibold text-slate-700 text-lg leading-relaxed">Student Profile</div>
    </div>
...
<script type="text/javascript">
    function search() {
        ...
        if (searchby == '') {
            ...
            $.ajax({
                type: 'POST',
                url: "{{url('controller/searchByRollNoOrNameToViewProfile')}}",
                data: {
                    "searchby": searchby,
                    "_token": token,
