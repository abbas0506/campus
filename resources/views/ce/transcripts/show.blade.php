...
<div class="container w-full mx-auto mt-8">
    <section id='registered' class="">
        <div class="flex justify-end border-b pb-4">
            <a href="{{url('transcripts/pdf', $student)}}" target='_blank' class="btn-teal flex items-center">
        ...
        <table class="table-auto w-full mt-8 text-sm">
            <thead>
            ...
            <tbody>
                ...
                <tr class="tr">
                    ...
                    <td class="py-1 pl-2 border">{{$first_attempt->course->name}} {{$first_attempt->attempt_stars()}}</td>
                    <td class="py-1 text-center border">{{$first_attempt->course->creditHrs()}}</td>
                    <td class="py-1 text-center border">{{$first_attempt->best_attempt()->total()}}</td>
