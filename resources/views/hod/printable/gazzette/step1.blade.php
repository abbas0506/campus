        ...
        <div class="body">
            ...
            <div class="flex items-center w-full border-b py-1 space-x-4">
                ...
                <div class="grid grid-cols-10 gap-2">
                    ...
                    <a href="{{route('hod.gazzette.preview',$section)}}" class='flex justify-center items-center bg-teal-100 hover:bg-teal-600 hover:text-slate-100 px-2 w-12'>
