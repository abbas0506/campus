...
<div class="container px-8">
    <div class="flex mb-5 flex-col md:flex-row md:items-center">
        <div class="flex items-center mt-12 mb-5 md:my-10">
            <h1 class="text-indigo-500 text-xl">Schemes</h1>
            <a href="{{route('schemes.create')}}" class="bg-indigo-600 hover:bg-indigo-500 ml-5 p-2 rounded-full flex text-slate-200">
    ...
    <table class="table-auto w-full">
        <thead>
            <tr class="border-b border-slate-200">
                <th class="py-2 text-gray-600 text-left">Scheme Name</th>
                <th class="py-2 text-gray-600 text-left">w.e.f</th>
        ...
        <tbody>
            ...
            <tr class="tr border-b">
                <td class="py-2">
                    <div>Scheme {{$scheme->semester->year}}</div>
                ...
                <td class="py-2">
                    <div class="flex items-center text-gray-500">
                        ...
                        <span class="ml-1 text-sm">{{$scheme->semester->semester_type->name}} {{$scheme->semester->year}} </span>
                    </div>
                ...
                <td class="flex items-center justify-center py-2">
                    ...
                    <form action="{{route('schemes.destroy',$scheme)}}" method="POST" id='del_form{{$scheme->id}}' class="mt-1">
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="bg-transparent p-0 border-0" onclick="delme('{{$scheme->id}}')">
