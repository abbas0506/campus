...
<div class="flex flex-col md:w-3/5 m-auto text-center mt-12">
    ...
    <div class="flex">
        <a class="tab active ">Step 1/3</a>
        <a class="tab">Sections</a>
    ...
    <form action="{{route('section-options.store')}}" method='post' class="flex flex-col w-full mt-12">
        @csrf
