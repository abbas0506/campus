...
<div class="bread-crumb">Course Plan / {{$section->title()}}</div>
...
<div class="container mt-12">
    ...
    <table class="table-auto w-full mt-8">
        ...
        <tbody>
            @php $roman=$roman=config('global.romans'); @endphp
            ...
            <tr>
                ...
                <td colspan="2">
                    ...
                    <div class="flex items-center border-b py-1">
                        ...
                        <form action="{{route('courseplan.destroy',$course_allocation)}}" method="POST" id='del_elective_form{{$course_allocation->id}}' class="mt-1 justify-end">
                            @csrf
                            @method('DELETE')
                    ...
                    @if($section->clas->semester_no==$semester_no)
                    <div class="flex items-center py-2">
                        <a href="{{route('courseplan.courses', $section)}}" class="">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4 text-indigo-600">
