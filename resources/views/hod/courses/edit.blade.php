...
<div class="container px-8">
    ...
    <form action="{{route('courses.update',$course)}}" method='post' class="flex flex-col w-full md:w-3/4">
        @csrf
        @method('PATCH')
        ...
        <div class="flex flex-col md:flex-row flex-wrap md:justify-between md:items-center">
            <div class="flex flex-col flex-1">
                ...
                <input type="text" id='' name='short' class="input-indigo" placeholder="SE" value="{{$course->short}}">
            </div>
        ...
        <div class="flex flex-col md:flex-row flex-wrap md:justify-between md:items-center">
            ...
            <div class="flex flex-col md:w-48 md:ml-4">
                ...
                <input type='number' id="" name="max_marks_theory" class="input-indigo p-1 pl-2" placeholder="Marks" value="{{$course->max_marks_theory}}">
            </div>
        </div>
