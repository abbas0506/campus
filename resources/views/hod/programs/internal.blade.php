...
<div class="container">
    ...
    <div class="mt-8 border border-dashed p-4">
        <div class="flex items-center justify-center space-x-4 ">
            ...
            <p class="text-slate-600 text-sm">/ Assign Internal</p>
        </div>
    </div>
    ...
    <div class="overflow-x-auto mt-8">
        ...
        <table class="table-fixed w-full mt-1">
            ...
            <tbody>
                ...
                <tr class="tr">
                    <td>
                        <form action="{{route('hod.programs.internal.update', $program->id)}}" method="POST" id='assign_form{{$teacher->id}}' class="flex items-center justify-center">
                            @csrf
                            @method('PATCH')
