    ...
    <form action="{{route('teachers.update',$teacher)}}" method='post' class="flex flex-col mt-16">
        ...
        <div class="flex flex-col md:flex-row">
            <div class="flex flex-col flex-1 mt-3">
                ...
                <input type="text" id='' name='name' class="input-indigo" placeholder="Dr. Sajjad Ahmad" value="{{$teacher->name}}" required>
            </div>
        </div>
        <div class="flex flex-col md:flex-row md:space-x-4">
            ...
            <div class="flex flex-col flex-1 mt-3">
                ...
                <input type="text" id='' name='email' class="input-indigo" placeholder="abc@uo.edu.pk" value="{{$teacher->email}}" required>
            </div>
        </div>
        ...
        <div class="flex flex-col md:flex-row md:space-x-4">
            <div class="flex flex-col flex-1 mt-3">
                ...
                <input type="text" id='cnic' name='cnic' class="input-indigo" placeholder="Without dashes" value="{{$teacher->cnic}}" required>
            </div>
            <div class="flex flex-col flex-1 mt-3">
                <label for="">Phone <span id="phone_length" class="text-slate-500 text-xs ml-3">0/11</span></label>
                <input type="text" id='phone' name='phone' class="input-indigo" placeholder="Without dash" value="{{$teacher->phone}}" required>
            </div>
        </div>
