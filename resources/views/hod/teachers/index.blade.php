...
<div class="container px-8">
    <div class="flex mb-5 flex-col md:flex-row md:items-center">
        <div class="flex items-center mt-12 mb-5 md:my-10">
            <h1 class="text-indigo-500 text-xl">Teachers</h1>
            <a href="{{route('teachers.create')}}" class="bg-indigo-600 hover:bg-indigo-500 ml-5 p-2 rounded-full flex text-slate-200">
            ...
            <tr class="tr border-b ">
                ...
                <td class="py-2 flex items-center justify-center">
                    ...
                    <form action="{{route('teachers.destroy',$teacher)}}" method="POST" id='del_form{{$teacher->id}}' class="mt-1">
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="bg-transparent p-0 border-0" onclick="delme('{{$teacher->id}}')">
