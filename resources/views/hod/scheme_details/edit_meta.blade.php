...
<h1>Study Scheme | Slot Update</h1>
<div class="flex items-center justify-between flex-wrap">
    <div class="bread-crumb">
        {{session('scheme')->title()}}-Semester {{$roman[$scheme_meta->semester_no-1]}}
    </div>
</div>
...
<div class="container">
    ...
    <div class="flex items-end justify-between mt-8">
        ...
        <div class="bg-teal-100">Choose for Scheme: <span class="font-semibold">{{session('scheme')->title()}}-Semester {{$roman[$scheme_meta->semester_no-1]}}</span> </div>
        <!-- <div class="ml-8">
    ...
    <table class="table-auto w-full mt-4">
        ...
        <tbody>
            ...
            <tr class="tr">
                ...
                <td>
                    <form action="{{route('scheme-details.update', $scheme_meta->id)}}" method="POST" id='assign_form{{$course->id}}' class="flex justify-center items-center ">
                        @csrf
                        @method('PATCH')
...
<script type="text/javascript">
    ...
    function assign(formid) {
        ...
        Swal.fire({
            title: 'Are you sure?',
            text: "Course slot is being added to scheme !",
            type: 'warning',
