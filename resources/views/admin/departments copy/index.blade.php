            ...
            <tr class="tr border-b ">
                <td class="py-2">
                    <div class="flex items-center">
                        <a href="{{route('departments.show', $department)}}" class="flex items-center text-blue-900 hover:text-blue-700 text-md ml-2">
                        ...
                        <a href="{{route('departments.edit', $department)}}" class="flex items-center text-green-800 hover:text-green-900 text-sm ml-4">
                            (...
                ...
                <td class="py-2">
                    ...
                    <div class="flex items-center py-2">
                        ...
                        <div class="text-xs text-slate-400 text-thin ml-2">(Assign HOD)</div>
                    </div>
                    @endif
                </td>
                <td>
