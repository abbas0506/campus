            ...
            <tr class="tr border-b">
                ...
                <td class="py-2">
                    ...
                    <div class="flex justify-center">
                        <a href="{{route('hods.edit',$department)}}" class="flex items-center bg-blue-200 p-2 rounded hover:bg-blue-300 text-blue-900">
                    ...
                    @else
                    <div class="flex justify-center">
                        <a href="{{route('hods.edit', $department)}}" class="flex items-center bg-green-200 p-2 rounded hover:bg-green-300 text-green-900">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
