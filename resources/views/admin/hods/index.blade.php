        ...
        <tbody>
            ...
            <tr class="tr border-b">
                ...
                <td class="py-2">
                    ...
                    <form action="{{route('departmenthods.destroy',$department)}}" method="POST" id='del_form{{$department->id}}' class="mt-1 flex justify-center">
                        @csrf
                        @method('DELETE')
                    ...
                    @else
                    <div class="flex justify-center">
                        <a href="{{route('departmenthods.edit', $department)}}" class="flex items-center bg-green-200 p-2 rounded hover:bg-green-300 text-green-900">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
