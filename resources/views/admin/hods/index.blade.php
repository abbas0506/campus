    ...
    <table class="table-auto w-full">
        <thead>
            <tr class="border-b border-slate-200">
                ...
                <th class="py-2 text-gray-600 text-left">HOD</th>
        ...
        <tbody>
            ...
            <tr class="tr border-b">
                ...
                <td class="py-2">
                    ...
                    <div class="text-sm text-gray-500 font-medium">{{$department->user->cnic}}</div>
                ...
                <td class="py-2">
                    ...
                    <form action="{{route('hods.destroy',$department)}}" method="POST" id='del_form{{$department->id}}' class="mt-1 flex justify-center">
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="flex items-center bg-red-200 px-2 rounded-full hover:bg-red-300 text-red-900" onclick="delme('{{$department->id}}')">
                    ...
                    <div class="flex justify-center">
                        <a href="{{url('assign/hod',$department)}}" class="flex items-center bg-green-200 px-2 rounded-full hover:bg-green-300 text-green-900">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
