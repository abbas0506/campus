...
<div class="container px-8">
    <div class="flex items-center">
        <h1 class="text-indigo-500 text-xl py-12">HODs <span class="text-gray-300 mx-3">|</span><span class='text-gray-600 text-sm'>Assign</span> </h1>
    </div>
    ...
    <a href='' class="flex items-center justify-center text-gray-600 border border-indigo-600 bg-indigo-100 hover:bg-indigo-200 mt-8 mb-5 p-4 w-full">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mr-3">
            <path stroke-linecap="round" stroke-linejoin="round" d="M15.042 21.672L13.684 16.6m0 0l-2.51 2.225.569-9.47 5.227 7.917-3.286-.672zm-7.518-.267A8.25 8.25 0 1120.25 10.5M8.288 14.212A5.25 5.25 0 1117.25 10.5" />
        </svg>

        Click me if you dont find desired person in following list
    </a>
