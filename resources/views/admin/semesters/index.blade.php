    ...
    <table class="table-auto w-full">
        <thead>
            <tr class="border-b border-slate-200">
                ...
                <th class="py-2 text-gray-600 text-left">Can Edit</th>
        ...
        <tbody>
            ...
            <tr class="tr border-b ">
                ...
                <td>
                    ...
                    <div class="text-sm text-green-800">Till {{$semester->edit_till}}</div>
                    @else
                ...
                <td class="py-2 flex items-center justify-center">
                    ...
                    <form action="{{route('semesters.destroy',$semester)}}" method="POST" id='del_form{{$semester->id}}' class="mt-1">
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="bg-transparent p-0 border-0" onclick="delme('{{$semester->id}}')">
