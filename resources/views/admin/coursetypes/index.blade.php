...
<h1 class="mt-12">Course Types</h1>
            ...
            <tr class="tr">
                ...
                <td>
                    <div class="flex justify-center items-center">
                        <a href="{{route('coursetypes.edit', $coursetype)}}">
                        ...
                        <form action="{{route('coursetypes.destroy',$coursetype)}}" method="POST" id='del_form{{$coursetype->id}}' class="mt-1">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="bg-transparent p-0 border-0" onclick="delme('{{$coursetype->id}}')">
