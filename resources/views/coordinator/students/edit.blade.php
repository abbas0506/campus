...
<div class="container">
    ...
    <div class="bread-crumb">
        <a href="{{route('coordinator.sections.show',$student->section)}}">{{$student->section->title()}}</a>
    </div>
    ...
    <div class="md:w-3/4 mx-auto mt-8">
        ...
        <form action="{{route('coordinator.students.update',$student)}}" method='post' class="mt-8">
            @csrf
            @method('PATCH')
