...
<div class="container">
    ...
    <div class="mt-12">
        ...
        <form action="{{route('coordinator.students.import')}}" method="POST" enctype="multipart/form-data" class="flex flex-col mt-8 w-full">
            @csrf
            ...
            <div class="flex items-center space-x-4 mt-6">
                ...
                <a href="{{route('coordinator.sections.show', $section)}}" class="btn-blue rounded p-2 w-24 text-center">Cancel</a>
            </div>
                ...
                <div class="px-12 py-8">
                    ...
                    <table class="table-auto w-full mt-8">
                        ...
                        <tbody>
                            ...
                            <tr class="tr">
                                <td class="text-center">ZOOL-114-23</td>
