...
<div class="container">
    ...
    <div class="bread-crumb">
        ...
        <div>/</div>
        <a href="{{route('coordinator.semester-plan.index')}}">Semester Plan</a>
        <div>/</div>
    ...
    <div class="flex flex-wrap items-center justify-center space-x-4 mt-8 border border-dashed p-4">
        ...
        <a href="{{route('coordinator.semester-plan.pdf',$section)}}" target='_blank' class="btn-teal text-sm"><i class="bi-printer"></i></a>
    </div>
        ...
        <table class="table-fixed w-full">
            ...
            <tbody>
                ...
                <tr class="tr">
                    ...
                    <td class="text-left">
                        <a href="{{route('coordinator.course-allocations.show',$course_allocation)}}" class=" text-left link">
