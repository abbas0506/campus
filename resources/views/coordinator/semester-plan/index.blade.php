...
<div class="container">
    ...
    <!-- records found -->
    <div class="text-xs font-thin text-slate-600 mt-8 mb-3">{{$user->programsBeingCoordinated->count()}} programs found</div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 w-full text-sm gap-4 border-b md:divide-x divide-slate-200 p-2">
                    ...
                    <div class="md:pl-4">
                        <div class="flex flex-wrap gap-2">
                            ...
                            <a href="{{route('coordinator.semester-plan.show',$section)}}" class='pallet-teal'>
