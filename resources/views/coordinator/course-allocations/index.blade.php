        ...
        <div class="overflow-x-auto">
            <table class="table-fixed w-full text-sm">
                ...
                <tbody>
                    ...
                    @foreach($user->courseAllocationsBeingCoordinated()->get() as $course_allocation)
                    <tr class="tr text-xs">
                        <td>
                        ...
                        <td>
                            ...
                            <a href="{{route('coordinator.assessment.pdf',$course_allocation)}}" target="_blank" class="text-blue-600 text-sm"><i class="bi-printer"></i></a>
                            @endif
                        </td>
                    </tr>
