...
<div class="container">
    ...
    <div class="bread-crumb">
        <a href="{{route('coordinator.course-allocations.show',$course_allocation)}}">Cancel & Go Back</a>
    </div>
    ...
    <div class="flex flex-col justify-center items-center border p-5 mt-4">
        ...
        <form action="{{route('coordinator.search.reappear.data')}}" method="post">
            @csrf
        ...
        <form id='action_form' action="{{route('coordinator.course-allocations.enrollment.reappear.post')}}" method="post" class="flex flex-col justify-center items-center w-full " onsubmit="return validate(event)">
            @csrf
