...
<div class="container">
    ...
    <div class="p-4 border border-dashed bg-white relative mt-4">
        ...
        <div class="flex items-center gap-x-4">
            <div> <a href="{{route('coordinator.course-allocations.enrollment.fresh', $course_allocation)}}" class="link">Fresh</a> <span class="text-slate-400 ml-2">({{$course_allocation->first_attempts->count()}})</span></div>
            <div>|</div>
