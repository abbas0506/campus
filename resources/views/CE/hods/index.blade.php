...
<div class="container px-8">
    <div class="flex mb-5 flex-col md:flex-row md:items-center">
        <div class="flex items-center mt-12 mb-5 md:my-12">
            <h1 class="text-indigo-500 text-xl">HODs</h1>
            <a href="{{route('headship.create')}}" class="bg-indigo-600 hover:bg-indigo-500 ml-5 p-2 rounded-full flex text-slate-200">
        ...
        <tbody>
            ...
            <tr class="border-b tr">
                ...
                <td class="py-2 flex items-center justify-center">
                    <a href="{{route('headship.edit', $user)}}">
                    ...
                    <form action="{{route('headship.destroy',$user)}}" method="POST" id='del_form{{$user->id}}' class="mt-1">
                        @csrf
                        @method('DELETE')
