...
<div class="container px-8">
    <div class="flex items-center">
        <h1 class="text-indigo-500 text-xl py-12">HODs</h1>
        <a href="{{route('hods.create')}}" class="bg-indigo-600 hover:bg-indigo-500 ml-5 p-2 rounded-full flex text-slate-200">
    ...
    <table class="table-auto w-full">
        <thead>
            <tr class="border-b border-t border-slate-200">
                <th class="py-2 text-gray-600 text-left">Name</th>
                <th class="py-2 text-gray-600 text-left">Email</th>
                <th class="py-2 flex justify-center"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
